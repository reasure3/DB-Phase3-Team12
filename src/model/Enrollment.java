...
public class Enrollment {
    ...
    public Enrollment(String enrollmentId, String enrollmentSource, int pointsUsed,
                      Date enrollmentTime, int studentId, String sectionId) {
    ...
    public void setEnrollmentTime(Date enrollmentTime) { this.enrollmentTime = enrollmentTime; }
