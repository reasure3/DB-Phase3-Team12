...
public class AuctionDAO extends BaseDao {
     ...
     */
    public List<Auction> selectByDepartment(String department) throws SQLException {
        String sql = 
     ...
     */
    public Map<Auction, Bid> selectMyAuctions(int studentId) throws SQLException {
        String sql = 
            "SELECT a.auction_id, a.start_time, a.end_time, a.status, a.available_slots, " +
            "       a.created_at, a.section_id, " +
            "       s.section_number, s.professor, " +
        ...
        Map<Auction, Bid> auctionBidMap = new HashMap<>();
     ...
     * 경매 ID로 조회
     */
    public Auction selectById(String auctionId) throws SQLException {
        String sql = 
            "SELECT a.auction_id, a.start_time, a.end_time, a.status, a.available_slots, " +
            "       a.created_at, a.section_id, " +
